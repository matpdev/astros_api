    ...
    jwt.verify(newAuthorization, process.env.SECRET, async (err, decoded) => {
      ...
      if (userExist) {
        ...
        const userDataUpdate = await prisma.userData.update({
          ...
          data: {
            imageIcon: `https://ahcdgbavrhtcenpncmmx.supabase.co/storage/v1/object/public/phodios/${data.data.path}`,
          },
        });
        ...
        if (artist) {
          ...
          const artistDataUpdate = await prisma.artist.update({
            ...
            data: {
              icon: `https://ahcdgbavrhtcenpncmmx.supabase.co/storage/v1/object/public/phodios/${data.data.path}`,
            },
          });
